...
export default function ArtistCard({ name, data, color }) {
  ...
  return (
    <div className={styles.card} style={{ '--card-color': color }}>
      <div className={styles.imgWrap}>
        {image ? (
          ...
          <div className={styles.placeholder}>
            <svg viewBox="0 0 24 24" fill="rgba(255,255,255,0.35)" width="52" height="52">
      ...
      <div className={styles.info}>
        ...
        {followers !== null && (
          <span className={styles.followers}>{formatFollowers(followers)} followers</span>
        )}
      </div>
